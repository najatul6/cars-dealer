...
const Navbar = () => {
  ...
  return (
    <header className="relative w-full py-[1.3rem] px-[2%] lg:py-3 lg:px-[2%]  flex justify-between items-center z-[100] before:content-[''] before:top-0 before:left-0 before:absolute before:w-full before:h-full before:bg-gradient-back before:backdrop-blur-[50px] before:z-[-1]  text-white font-bold">
       ...
       <ul className="flex flex-col lg:flex-row justify-between items-center gap-6 px-5 py-5 md:py-2 lg:py-0">
        ...
        <div className="flex flex-col lg:flex-row justify-center items-center gap-5 ">
            ...
            <div className="grid grid-flow-col gap-4">
              {/* Twitter */}
              <Link to="https://x.com/MNajatul" className="hover:text-Dark-blue cursor-pointer" target="_blank">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
              ...
              {/* Youtube */}
              <Link to="https://www.youtube.com/@BitWorks-m3e" className="hover:text-Dark-blue cursor-pointer" target="_blank">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
              ...
              {/* Facebook */}
              <Link to="https://www.facebook.com/najatul6/" className="hover:text-Dark-blue cursor-pointer" target="_blank">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
