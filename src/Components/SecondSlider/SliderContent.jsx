  ...
  return (
    <div className="flex bg-white justify-center items-center px-5">
      <div className="bg-white shadow-2xl flex flex-col justify-start items-start p-20 gap-5">
        ...
        <h3 className="bg-Dark-blue py-4 px-2 text-xl font-light uppercase text-white">
          {subtitle}
        </h3>
      ...
      <div className="w-full flex justify-center items-center relative">
        ...
        <p className="text-xl -skew-x-[25deg] font-bold uppercase text-white py-3 px-2 bg-regal-blue ">
          From {price}
        </p>
        </div>
      </div>
